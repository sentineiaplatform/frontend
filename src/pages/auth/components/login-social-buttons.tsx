...
/** Logo Microsoft (4 quadrados de marca). */
const microsoftIcon = (
  <svg aria-hidden className="size-4 shrink-0" viewBox="0 0 24 24">
    <path fill="#f25022" d="M1 1h11v11H1z" />
    <path fill="#7fba00" d="M12 1h11v11H12z" />
    <path fill="#00a4ef" d="M1 12h11v11H1z" />
...
export function LoginSocialButtons({ className }: Props) {
  return (
